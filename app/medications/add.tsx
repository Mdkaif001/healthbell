...
export default function AddMedicationScreen() {
  ...
  const handleSave = async () => {
    try {
      ...
      const colors = ["#1c6ba4", "#2196F3", "#FF9800", "#E91E63", "#9C27B0"];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          >
            <Ionicons name="chevron-back" size={28} color="#1c6ba4" />
          </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.dateIconContainer}>
                <Ionicons name="calendar" size={20} color="#1c6ba4" />
              </View>
                ...
                {form.times.map((time, index) => (
                  ...
                  >
                    <View style={styles.timeIconContainer}>
                      <Ionicons name="time-outline" size={20} color="#1c6ba4" />
                    </View>
              ...
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="notifications" size={20} color="#1c6ba4" />
                  </View>
                  <View>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#ddd", true: "#1c6ba4" }}
                  thumbColor="white"
                />
              </View>
            </View>
          ...
          <View style={styles.section}>
            <View style={styles.card}>
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="reload" size={20} color="#1c6ba4" />
                  </View>
                  <View>
