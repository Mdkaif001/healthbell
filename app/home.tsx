...
const QUICK_ACTIONS = [
  {
    ...
    color: "#dcedf9",
    gradient: ["#f495bbff", "#e4558eff"] as [string, string],
  },
  {
    ...
    color: "#1976D2",
    gradient: ["#ecc672ff", "#d99f23ff"] as [string, string],
  },
  {
    ...
    color: "#C2185B",
    gradient: ["#38bd93ff", "#008a5e"] as [string, string],
  },
  {
...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <LinearGradient colors={["#1c6ba4", "#7ab5dfff"]} style={styles.header}>
